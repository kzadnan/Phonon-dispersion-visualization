...
species_map=  {1: 'C',2: 'Zr'}

deepmd_order = [species_map[i] for i in sorted(species_map.keys())] ##This is just the potential order in the training of MLIPs

 #C480N0Al0Ti0Ga0Au0
Lammps_poscar("Zr_primitive_cell.txt","POSCAR",species_map)
## Defining the supercell size 2*2*2
supercell_matrix=np.array([[4,0,0],[0,4,0],[0,0,4]])#4*np.diag([1,1,1])
## Making SPOSCAR
